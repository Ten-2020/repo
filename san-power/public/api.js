window.TMAP_AUTHKEY = "6b70c485070aaf4ebb89cac857d2a549";
window.T = window.T || {};
(function () {
  function each(t, i) {
  ...
  T.Version = "4.1.1", T.q = {
    ...
    }, T.Protocol.protocol(), T.tk = "tk=" + window.TMAP_AUTHKEY + "&", T.Domain = "gov.cn", T.w = {
      ...
      r: function () {
        return T.Protocol.value + "t" + T.q.W(0, 7) + ".tianditu." + T.Domain + "/DataServer?T=vec_c&" + T.tk
      },
      T: function () {
        return T.Protocol.value + "t" + T.q.W(0, 7) + ".tianditu." + T.Domain + "/DataServer?T=cva_c&" + T.tk
      },
      t: function () {
        return T.Protocol.value + "t" + T.q.W(0, 7) + ".tianditu." + T.Domain + "/DataServer?T=vec_w&" + T.tk
      },
      Y: function () {
        return T.Protocol.value + "t" + T.q.W(0, 7) + ".tianditu." + T.Domain + "/DataServer?T=cva_w&" + T.tk
      },
      U: function () {
    ...
    function () {
    ...
    }(), T.extend = T.S.extend, T.D = T.S.D, T.d = T.S.d, T.setOptions = T.S.setOptions, T.c = function () {}, T.c.extend = function (t) {
      var i = function () {
      ...
      return t.v && (T.extend(i, t.v), delete t.v), t.includes && (T.S.extend.apply(null, [e].concat(t.includes)), delete t.includes), e.options && (t.options = T.S.extend(T.S.s(e.options), t.options)), T.extend(e, t), e.N = [], e.B = function () {
        if (!this.b) {
  ...
  pro.addEventListener = pro.on, pro.removeEventListener = pro.YQ = pro.off, pro.UQ = pro.rQ, pro.uQ = pro.trigger, pro.IQ = pro.EQ, T.iQ = {
      OQ: pro
    },
    function () {
      ...
      extend: function (t) {
        return t = T.SQ(t), this.min || this.max ? (this.min.x = Math.min(t.x, this.min.x), this.max.x = Math.max(t.x, this.max.x), this.min.y = Math.min(t.y, this.min.y), this.max.y = Math.max(t.y, this.max.y)) : (this.min = t.pQ(), this.max = t.pQ()), this
      },
      ...
      contains: function (t) {
        var i, n;
        return t = "number" == typeof t[0] || t instanceof T.Point ? T.SQ(t) : T.cQ(t), t instanceof T.ZQ ? (i = t.min, n = t.max) : i = n = t, i.x >= this.min.x && n.x <= this.max.x && i.y >= this.min.y && n.y <= this.max.y
      },
    ...
    function () {
      ...
      if (T._Q.iq = "webkitTransition" === t || "OTransition" === t ? t + "End" : "transitionend", "onselectstart" in document) T._Q.Oq = function () {
      ...
      T._Q.Aq = function () {
        ...
        t && t.style && (T._Q.sq(), this.Dq = t, this._outlineStyle = t.style.outline, t.style.outline = "none", T.oq.on(window, "keydown", T._Q.sq, this))
      }, T._Q.sq = function () {
        this.Dq && (this.Dq.style.outline = this._outlineStyle, delete this.Dq, delete this._outlineStyle, T.oq.off(window, "keydown", T._Q.sq, this))
      }
    }(), T.dq = function (t, i, n) {
      ...
      extend: function (t) {
        ...
        return e || o ? (e.lat = Math.min(i.lat, e.lat), e.lng = Math.min(i.lng, e.lng), o.lat = Math.max(n.lat, o.lat), o.lng = Math.max(n.lng, o.lng)) : (this.kq = new T.dq(i.lat, i.lng), this.Lq = new T.dq(n.lat, n.lng)), this
      },
      lq: function (t) {
        var i = this.kq,
          n = this.Lq,
      ...
      contains: function (t) {
        ...
        var i, n, e = this.kq,
          o = this.Lq;
        return t instanceof T.Kq ? (i = t.getSouthWest(), n = t.getNorthEast()) : i = n = t, i.lat >= e.lat && n.lat <= o.lat && i.lng >= e.lng && n.lng <= o.lng
      },
      intersects: function (t) {
        t = T.jq(t);
        var i = this.kq,
      ...
      initialize: function (t, i) {
        i = T.setOptions(this, i), this.SW = "EPSG:900913", i.projection ? 
        "EPSG:4326" == i.projection ? (i.IW = T.gq.uW, this.SW = "EPSG:4326", 
        T.gq.EW = 1) : (i.IW = T.gq.UW, this.SW = "EPSG:900913", 
        i.projection = this.SW, T.gq.EW = 0) : i.projection = this.SW, this.sW(t), this.DW(), 
        this.dW = T.D(this.dW, this), this.FW(), i.maxBounds && this.setMaxBounds(i.maxBounds), 
        void 0 !== i.zoom && (this.fW = this.GW(i.zoom)), i.center && 
        void 0 !== i.zoom && this.gW(T.fq(i.center), i.zoom, {
          reset: !0
        }), this.HW = [], this.hW = {}, this.JW = [], this.jW = [], this.KW = {}, this.kW = !0, this.initLayers = [], this.B(), this.defaultMapType = null, this.LW(this), this.lW(this.options.layers)
      },
      getCode: function () {
        return this.SW
      },
      ...
      setMaxBounds: function (t) {
        return t = T.jq(t), t.vQ() ? (this.options.maxBounds && this.off("moveend", this.ww), this.options.maxBounds = t, this.CW && this.ww(), this.on("moveend", this.ww)) : (this.options.maxBounds = null, this.off("moveend", this.ww))
      },
      setMinZoom: function (t) {
        return this.options.minZoom = t, this.CW && this.getZoom() < this.options.minZoom ? this.setZoom(t) : (this.wQ("minzoom", {
          minZoom: this.options.minZoom,
          maxZoom: this.options.maxZoom
        }), this)
      },
      setMaxZoom: function (t) {
        return this.options.maxZoom = t, this.CW && this.getZoom() > this.options.maxZoom ? this.setZoom(t) : (this.wQ("maxzoom", {
          minZoom: this.options.minZoom,
          maxZoom: this.options.maxZoom
        }), this)
      },
      ...
      rw: function (t) {
        ...
        var n = this.getSize(),
          ...
          o = n.dQ(2).hQ(),
          s = e.sQ(o);
        return s.x || s.y ? (t.Tw && t.qw ? this.panBy(s) : (t.qw && this.Ww(s), this.wQ("move"), t.Yw ? (clearTimeout(this.Uw), this.Uw = setTimeout(T.D(this.wQ, this, "moveend"), 200)) : this.wQ("moveend")), this.wQ("resize", {
          oldSize: i,
          newSize: n
        })) : this
      },
      ...
      nW: function (t, i, n) {
        ...
        return e = this.gw(l, e), c && (e = Math.round(e / (c / 100)) * (c / 100), e = i ? Math.ceil(e / c) * c : Math.floor(e / c) * c), Math.max(o, Math.min(s, e))
      },
      getSize: function () {
        return this.Hw && !this.kW || (this.Hw = new T.Point(this.Ow.clientWidth, this.Ow.clientHeight), this.kW = !1), this.Hw.pQ()
      },
      Fw: function (t, i) {
        var n = this.hw(t, i);
      ...
      setCrs: function (t) {
        ...
        "EPSG:900913" == t ? (this.options.IW = T.gq.UW, this.SW = t, T.gq.EW = 0) : (this.options.IW = T.gq.uW, this.SW = t, T.gq.EW = 1), this.setMapType(this.getMapType()), this.ZW(i, this.getZoom())
      },
      ...
      DW: function () {
        var t = this.Ow;
        this.Nw = this.options.OW && T.oQ.any3d, T._Q.Rq(t, "tdt-container" + (T.oQ.touch ? " tdt-touch" : "") + (T.oQ.retina ? " tdt-retina" : "") + (T.oQ.ielt9 ? " tdt-oldie" : "") + (T.oQ.safari ? " tdt-safari" : "") + (this.Nw ? " tdt-fade-anim" : ""));
        var i = T._Q.getStyle(t, "position");
        "absolute" !== i && "relative" !== i && "fixed" !== i && (t.style.position = "relative"), this.bw(), this.Mw && this.Mw()
      },
      bw: function () {
        var t = this.aw = {};
        this.nw = {}, this.ow = this.Aw("mapPane", this.Ow), T._Q.setPosition(this.ow, new T.Point(0, 0)), this.Aw("tilePane"), this.Aw("_w"), this.Aw("overlayPane"), this.Aw("markerPane"), this.Aw("infoWindowPane"), this.options.PW || (T._Q.Rq(t.markerPane, "tdt-zoom-hide"), T._Q.Rq(t._w, "tdt-zoom-hide"))
      },
      ZW: function (t, i) {
      ...
      QE: function (t, i, n) {
        void 0 === i && (i = this.fW);
        var e = this.fW !== i;
        return this.fW = i, this.tw = t, this.jw = this.WE(t), (e || n && n.pinch) && this.wQ("zoom", n), this.wQ("move", n)
      },
      mw: function (t) {
      ...
      FW: function (t) {
        if (T.oq) {
          ...
          var i = t ? "off" : "on";
          T.oq[i](this.Ow, "click dblclick mousedown mouseup mouseover mouseout mousemove contextmenu keypress", this.rE, this), this.options.oW && T.oq[i](window, "resize", this.dW, this), T.oQ.any3d && this.options.pW && this[i]("moveend", this.TE)
        }
      },
      dW: function () {
      ...
      oE: function (t, i, n) {
        ...
        if (!t._stopped && (n = (n || []).concat(this.YE(t, i)), n.length)) {
          ...
          for (var h = 0; h < n.length; h++)
            if (n[h].wQ(i, s, !0), s.originalEvent._stopped || n[h].options.pE && T.S.indexOf(n[h].options.pE, i) !== -1) return
        }
      },
      IE: function (t) {
      ...
      setStyle: function (t) {
        t = t || "black", "black" == t ? this.Ow.style.backgroundColor = "#000000" : this.Ow.style.backgroundColor = "#466399", this.defaultMapType.getLayers()[0].on("tileload", function (t) {
      ...
      removeStyle: function () {
        this.Ow.style.backgroundColor = "", this.defaultMapType.getLayers()[0].off("tileload"), this.defaultMapType.getLayers()[1].off("tileload"), this.ZW(this.getCenter(), this.getZoom())
      }
    }), T.gE = function (t, i) {
      ...
      lE: function (t) {
        ...
        if (i.hasLayer(this)) {
          ...
          this.onAdd(i), this.VE && this.jE.cE && this.jE.cE.BE(this.VE()), this.wQ("AQ"), i.wQ("layeradd", {
            layer: this
          })
        }
      }
      ...
      removeLayer: function (t) {
        var i = T.d(t);
        return this.hW[i] ? (this.CW && t.onRemove(this), t.VE && this.cE && this.cE.NE(t.VE()), delete this.hW[i], this.CW && (this.wQ("layerremove", {
          layer: t
      ...
      setMapType: function (t) {
        t && (this.defaultMapType && this.clearMapType(this.defaultMapType), this.addLayer(t), this.defaultMapType = t), this.wQ("maptypechange", {
          mapType: t
        })
      },
      ...
      lW: function (t) {
        if (t = t ? T.S.l(t) ? t : [t] : [], 0 == t.length) this.defaultMapType = TMAP_NORMAL_MAP, t = [TMAP_NORMAL_MAP];
        else
      ...
      load: function (t, i, n, e) {
        if (this.objName = "tdt_loadResult", this.win = window, this.charset = i ? i : "utf-8", this.src = t ? t : null, null != this.src) {
          ...
          var o = this.win;
          o[this.objName] = null, this.oScript = document.createElement("script"), this.oScript.type = "text/javascript", this.oScript.async = !0, this.oScript.charset = this.charset, this.oScript.src = this.src, this.running = !0;
          var n = this;
      ...
      return t || (t = []), t[0] || (t[0] = T.ScriptLoader.qe().event), t[0] && !t[0].target && t[0].srcElement && (t[0].target = t[0].srcElement), t
      ...
      _q: function (t) {
        for (var i, n = 180 / Math.PI, e = this.R, o = this.Ee / e, s = Math.sqrt(1 - o * o), r = Math.exp(-t.y / e), h = Math.PI / 2 - 2 * Math.atan(r), a = 0, u = .1; a < 15 && Math.abs(u) > 1e-7; a++) i = s * Math.sin(h), i = Math.pow((1 - i) / (1 + i), s / 2), u = Math.PI / 2 - 2 * Math.atan(r * i) - h, h += u;
      ...
      Ae: function (t) {
        for (var i, n = this.getPane().children, e = -t(-(1 / 0), 1 / 0), o = 0, s = n.length; o < s; o++) i = n[o].style.zIndex, n[o] !== this.Ow && i && (e = t(e, +i));
      ...
      sW: function () {
        this.Ow || (this.Ow = T._Q.s("div", "tdt-layer " + (this.options.className || "")), this.se(), this.options.opacity < 1 && this.Se(), this.getPane().appendChild(this.Ow))
      },
      Le: function () {
        var t = this.Pe,
          i = this.options.maxZoom;
        if (void 0 !== t) {
          for (var n in this.Ie) this.Ie[n].el.children.length || n === t ? this.Ie[n].el.style.zIndex = i - Math.abs(t - n) : (T._Q.Qq(this.Ie[n].el), this.le(n), delete this.Ie[n]);
          var e = this.Ie[t],
            o = this.jE;
          return e || (e = this.Ie[t] = {}, e.el = T._Q.s("div", "tdt-tile-container tdt-zoom-animated", this.Ow), e.el.style.zIndex = i, e.origin = o.nq(o._q(o.Jw()), t).hQ(), e.zoom = t, this.Ze(e, o.getCenter(), o.getZoom()), T.S.H(e.el.offsetWidth)), this.Ce = e, e
        }
      },
      Ke: function () {
        if (this.jE) {
      ...
      be: function (t, i, n, e) {
        ...
        e && !s || (this.Pe = o, this.Me && this.Me(), this.Le(), this.ne(), void 0 !== o && this.Oe(t), n || this.Ke(), this.je = !!n), this._e(t, i)
      },
      _e: function (t, i) {
      ...
      ne: function () {
        ...
        o && (this.QR = this.qR(o)), this.WR = i.rW && !this.options.ue && [Math.floor(t.nq([0, i.rW[0]], e).x / n.x), Math.ceil(t.nq([0, i.rW[1]], e).x / n.y)], this.wR = i.wrapLat && !this.options.ue && [Math.floor(t.nq([i.wrapLat[0], 0], e).y / n.x), Math.ceil(t.nq([i.wrapLat[1], 0], e).y / n.y)]
      },
      TE: function () {
      ...
      rR: function (t) {
        ...
        if (!i.RW) {
          var n = this.QR;
          if (!i.rW && (t.x < n.min.x || t.x > n.max.x) || !i.wrapLat && (t.y < n.min.y || t.y > n.max.y)) return !1
        }
      ...
      uR: function (t) {
        T._Q.Rq(t, "tdt-tile");
        var i = this.he();
        t.style.width = i.x + "px", t.style.height = i.y + "px", t.onselectstart = T.S.H, t.onmousemove = T.S.H, T.oQ.ielt9 && this.options.opacity < 1 && T._Q.setOpacity(t, this.options.opacity), T.oQ.android && !T.oQ.android23 && (t.style.WebkitBackfaceVisibility = "hidden")
      },
      TR: function (t, i) {
        var n = this.IR(t),
          e = this.ve(t),
          o = this.He(this.iR(t), T.D(this.OR, this, t));
        this.uR(o), this.He.length < 2 && T.S.C(T.D(this.OR, this, t, null, o)), T._Q.setPosition(o, n), this.ie[e] = {
          el: o,
          coords: t,
          Je: !0
      ...
      OR: function (t, i, n) {
        if (this.jE) {
          ...
          n = this.ie[e], n && (n.loaded = +new Date, this.jE.Nw ? (T._Q.setOpacity(n.el, 0), T.S.V(this.ke), this.ke = T.S.C(this.Se, this)) : (n.active = !0, this.Ke()), T._Q.Rq(n.el, "tdt-tile-loaded"), this.wQ("tileload", {
            tile: n.el,
            coords: t
          }), this.oR() && (this.de = !1, this.wQ("load"), T.oQ.ielt9 || !this.jE.Nw ? T.S.C(this.Ke, this) : setTimeout(T.D(this.Ke, this), 250)))
        }
      },
      IR: function (t) {
      ...
      initialize: function (t, i) {
        this.FR = "", t && (this.FR = t), i = T.setOptions(this, i), i.DR && T.oQ.retina && i.maxZoom > 0 && (i.Te = Math.floor(i.Te / 2), i.sR ? (i.AR--, i.minZoom++) : (i.AR++, i.maxZoom--), i.minZoom = Math.max(0, i.minZoom)), "string" == typeof i.pR && (i.pR = i.pR.split("")), T.oQ.android || this.on("tileunload", this.fR)
      },
      setUrl: function (t, i) {
      ...
      Me: function () {
        var t, i;
        for (t in this.ie) this.ie[t].coords.z !== this.Pe && (i = this.ie[t].el, i.onload = T.S.H, i.onerror = T.S.H, i.complete || (i.src = T.S.Z, T._Q.Qq(i)))
      }
    }), T.JR = function (t, i) {
      ...
      initialize: function (t, i) {
        ...
        i = T.setOptions(this, i), this.wmsSrs = "EPSG:900913", i.srs ? "EPSG:4326" == i.srs ? (i.IW = T.gq.uW, this.wmsSrs = "EPSG:4326") : (i.IW = T.gq.UW, i.srs = "EPSG:900913", this.wmsSrs = "EPSG:900913") : i.srs = this.wmsSrs, n.width = n.height = i.Te * (i.DR && T.oQ.retina ? 2 : 1), this.KR = n
      },
      onAdd: function (t) {
      ...
      CR: function (t, i, n) {
        if (window.localStorage) {
          ...
          null == o || 0 == o.length || this.ZR != localStorage.getItem("TDT_version") ? (document.write('<script type="text/javascript" src="' + i + '"></script>'), window.ActiveXObject ? e = new ActiveXObject("Microsoft.XMLHTTP") : window.XMLHttpRequest && (e = new XMLHttpRequest), null != e && (e.open("GET", i), e.send(null), e.onreadystatechange = function () {
            4 == e.readyState && 200 == e.status && (o = e.responseText, localStorage.setItem(t, o), localStorage.setItem("TDT_version", T.lR.ZR), null != n && n())
          })) : (T.lR.VR(o), null != n && n())
        } else T.lR.cR(i)
      },
      BR: function (t, i) {
        ...
        if (window.localStorage) {
          ...
          null == e || 0 == e.length || this.ZR != localStorage.getItem("TDT_version") ? (window.ActiveXObject ? n = new ActiveXObject("Microsoft.XMLHTTP") : window.XMLHttpRequest && (n = new XMLHttpRequest), null != n && (n.open("GET", i), n.send(null), n.onreadystatechange = function () {
            4 == n.readyState && 200 == n.status && (e = n.responseText, localStorage.setItem(t, e), localStorage.setItem("TDT_version", T.lR.ZR), e = null == e ? "" : e, T.lR.NR(e))
          })) : T.lR.NR(e)
        } else T.lR.vR(i)
      },
      VR: function (t) {
      ...
      MR: function (t, i) {
        ...
        if (window.localStorage) {
          ...
          null == n || 0 == n.length || this.ZR != localStorage.getItem("TDT_version") ? (T.lR.vR(i), i.indexOf("tianditu4.0") != -1 && (i = T.w.E + "/api?v=4.0&name=tianditu4.0"), T.lR.bR(i, function () {
            T.ObjectData && (n = T.ObjectData), localStorage.setItem(t, n), localStorage.setItem("TDT_version", T.lR.ZR), T.ObjectData = null
          })) : T.lR.NR(n)
        }
      },
      nR: function (t, i) {
      ...
      Wr: function () {
        ...
        t.onselectstart = T.S.H, t.onmousemove = T.S.H, t.onload = T.D(this.wQ, this, "load"), this.options.dR && (t.dR = ""), t.src = this.FR, t.Fq = this.options.Fq
      },
      ge: function (t) {
      ...
      rr: function (t, i) {
        var n = this.tr(t);
        return n ? (this.img = this.Yr(n, i && "IMG" === i.tagName ? i : null), this.er(this.img, t), this.img) : null
      },
      er: function (t, i) {
        var n = this.options,
          e = n[i + "Size"];
        ...
        t.className = "tdt-marker-" + i + " " + (n.className || ""), s && (t.style.marginLeft = -s.x + "px", t.style.marginTop = -s.y + "px"), o && (t.style.width = o.x + "px", t.style.height = o.y + "px")
      },
      Yr: function (t, i) {
      ...
      setIcon: function (t) {
        return this.options.icon = t, this.jE && (this.pr(), this.update()), this.Dr && this.dr(this.Dr, this.Dr.options), this
      },
      getIcon: function () {
      ...
      pr: function () {
        var t = this.options,
          ...
          n = t.icon.Rr(this.Fr),
          e = !1;
        n !== this.Fr && (this.Fr && this.ar(), e = !0, t.title && (n.title = t.title), t.Fq && (n.Fq = t.Fq)), T._Q.Rq(n, i), t.Ir && (n.tabIndex = "0"), this.Fr = n, t.ir && this.on({
          mouseover: this.Gr,
          mouseout: this.gr
        });
        var o = t.icon.Tr(this.Hr),
          s = !1;
        o !== this.Hr && (this.Sr(), s = !0), o && T._Q.Rq(o, i), this.Hr = o, t.opacity < 1 && this.Se(), e && this.getPane().appendChild(this.Fr), this.hr(), o && s && this.getPane("_w").appendChild(this.Hr)
      },
      ar: function () {
      ...
      fr: function (t) {
        T._Q.setPosition(this.Fr, t), this.Hr && T._Q.setPosition(this.Hr, t), this.Jr = t.y + this.options.zIndexOffset, this.gr()
      },
      se: function (t) {
      ...
      onAdd: function (t) {
        this.ZE = this.ZE && this.options.Nr, this.Ow || this.DW(), t.Nw && T._Q.setOpacity(this.Ow, 0), clearTimeout(this.Mr), this.getPane().appendChild(this.Ow), this.update(), t.Nw && T._Q.setOpacity(this.Ow, 1), t.wQ("nr", {
          _r: this
        }), this.wQ("open", {
          lnglat: this.or
      ...
      onRemove: function (t) {
        t.Nw ? (T._Q.setOpacity(this.Ow, 0), this.Mr = setTimeout(T.D(T._Q.Qq, T._Q, this.Ow), 200)) : T._Q.Qq(this.Ow), t.wQ("qT", {
          _r: this
        }), this.wQ("close", {
          lnglat: this.or,
          infowindow: this
      ...
      DW: function () {
        ...
        this.uT = T._Q.s("div", t + "-content", e), T.oq.iT(e).IT(this.uT).on(e, "contextmenu", T.oq.stopPropagation), this.OT = T._Q.s("div", t + "-tip-container", i), this.oT = T._Q.s("div", t + "-tip", this.OT)
      },
      eT: function () {
        if (this.ET) {
          var t = this.uT,
      ...
      wT: function () {
        if (!(!this.options.autoPan || this.jE.EE && this.jE.EE.aT)) {
          ...
          var o = t.Zw(e),
            ...
            u = 0,
            c = 0;
          o.x + n + h.x > a.x && (u = o.x + n - a.x + h.x), o.x - u - r.x < 0 && (u = o.x - r.x), o.y + i + h.y > a.y && (c = o.y + i - a.y + h.y), o.y - c - r.y < 0 && (c = o.y - r.y), (u || c) && t.wQ("ST").panBy([u, c])
        }
      },
      YT: function (t) {
        this.rT(), T.oq.uw(t)
      ...
      QT: function (t, i, n) {
        return t instanceof T.Zr || (t = new T.Zr(n).setContent(t)), i && t.sr(i), this.hasLayer(t) ? this : (this.Dr && this.Dr.options.Br && this.TT(), this.Dr = t, this.addLayer(t))
      },
      ...
      dr: function (t, i) {
        return t instanceof T.Zr ? (T.setOptions(t, i), this.Dr = t, t.br = this) : (this.Dr && !i || (this.Dr = new T.Zr(i, this)), this.Dr.setContent(t)), this.DT || (this.on({
          Qq: this.TT,
          move: this.dT
        }), this.DT = !0), this
      },
      ...
      QT: function (t, i) {
        ...
        return i || (i = t.getCenter ? t.getCenter() : t.PE()), this.Dr && this.jE && (this.Dr.br = t, this.Dr.update(), this.jE.QT(this.Dr, i)), this
      },
      TT: function () {
      ...
      JT: function (t) {
        ...
        if (this.Dr && this.jE) return T.oq.uw(t), i instanceof T.jT ? void this.QT(t.layer || t.target, t.KT) : void(this.jE.hasLayer(this.Dr) && this.Dr.br === i ? this.TT() : this.QT(i, t.KT))
      },
      dT: function (t) {
        this.Dr.sr(t.KT)
      }
      ...
      addLayer: function (t) {
        return this.hasLayer(t) ? this : (t.TQ(this), T.LayerGroup.prototype.addLayer.call(this, t), this.wQ("layeradd", {
          layer: t
        }))
      },
      removeLayer: function (t) {
        return this.hasLayer(t) ? (t in this.hW && (t = this.hW[t]), t.tQ(this), T.LayerGroup.prototype.removeLayer.call(this, t), this.wQ("layerremove", {
          layer: t
        })) : this
      },
      setStyle: function (t) {
      ...
      LW: function (t) {
        ...
        i.getTileUrl = function (t) {
          return 0 == T.gq.EW ? T.w.t() + "x=" + t.x + "&y=" + t.y + "&l=" + t.z : T.w.r() + "x=" + t.x + "&y=" + t.y + "&l=" + t.z
        };
        ...
        n.getTileUrl = function (t) {
          return 0 == T.gq.EW ? T.w.Y() + "x=" + t.x + "&y=" + t.y + "&l=" + t.z : T.w.T() + "x=" + t.x + "&y=" + t.y + "&l=" + t.z
      ...
      getCenter: function () {
        ...
        for (t = 0, e = 0; t < a - 1; t++)
          if (o = h[t], s = h[t + 1], n = o.distanceTo(s), e += n, e > i) return r = (e - i) / n, this.jE.Dw([s.x - r * (s.x - o.x), s.y - r * (s.y - o.y)])
      },
      getBounds: function () {
        return this.Qr
      },
      ...
      Nt: function () {
        ...
        if (this.Lt = [], this.vt && this.vt.intersects(t)) {
          ...
          for (i = 0, e = 0, o = this.lt.length; i < o; i++)
            for (h = this.lt[i], n = 0, s = h.length; n < s - 1; n++) r = T.ut.St(h[n], h[n + 1], t, n, !0), r && (a[e] = a[e] || [], a[e].push(r[0]), r[1] === h[n + 1] && n !== s - 2 || (a[e].push(r[1]), e++))
        }
      },
      bt: function () {
      ...
      initialize: function (t, i, n) {
        "number" == typeof i && (i = T.extend({}, n, {
          radius: i
        })), T.setOptions(this, i), this.or = T.fq(t), isNaN(this.options.radius), this.UY = this.options.radius, this.gt = "solid", this.options.lineStyle && this.setLineStyle(this.options.lineStyle)
      },
      getType: function () {
        return this.options.type
      },
      ...
      for (o = 0, h = this.Lt.length; o < h; o++)
        for (i = this.Lt[o], s = 0, a = i.length, r = a - 1; s < a; r = s++) n = i[s], e = i[r], n.y > t.y != e.y > t.y && t.x < (e.x - n.x) * (t.y - n.y) / (e.y - n.y) + n.x && (u = !u);
  ...
  T.oq = {
    ...
    ai: function (t) {
      ...
      i && i.id !== this._activeLayerId && (this._previousLayerId = this._activeLayerId, this._activeLayerId = i.id, this.Ow && this.Ai(), this.wQ("activelayerchange", {
        layer: t
      }))
    },
    expand: function () {
    ...
    si: function (t) {
      if ("Microsoft Internet Explorer" != navigator.appName || "MSIE8.0" != navigator.appVersion.split(";")[1].replace(new RegExp("[ ]", "g"), "")) var i = this.Ow.getElementsByClassName("tdt-iconLayers-layerCell");
    ...
    Hi: function () {
      if (each(this.hW, function (t) {
        ...
        }.D(this)), "Microsoft Internet Explorer" != navigator.appName || "MSIE8.0" != navigator.appVersion.split(";")[1].replace(new RegExp("[ ]", "g"), "")) var t = this.Ow.getElementsByClassName("tdt-iconLayers-layersRow");
  ...
  zoomAnimated && T.Map._(function () {
    ...
    Ne: function (t, i, n) {
      ...
      function c() {
        var n = (Date.now() - Q) / x,
          e = u(n) * q;
        n <= 1 ? (this.wE = T.S.C(c, this), this.QE(this._q(l.AQ(f.sQ(l).fQ(a(e) / w)), p), this.gw(m / h(e), p), {
          Ne: !0
        })) : this.QE(t, i).mw(!0)
      }
